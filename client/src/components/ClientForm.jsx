...
const ClientForm = ({ onClose, onClientChanged, clientToEdit, isEditing = false }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      if (isEditing) {
        ...
        const updatedClient = await updateClient(clientToEdit._id, formData);
