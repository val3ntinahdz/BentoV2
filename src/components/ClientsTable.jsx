              ...
              <TableCell>
                <div className="flex items-center justify-center gap-3">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-[#fbbf24]/10 text-[#fbbf24] transition-all"
                    title="View"
                  >
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-[#84cc16]/10 text-[#7cb823] transition-all"
                    title="View"
                  >
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-[#d77272]/10 text-[#c43d3d] transition-all"
                    title="Delete"
                  >
